...
class TestEllipticalArc(unittest.TestCase):
    ...
    def testExtraArgs(self):
        self.assertEqual(
            ellipticalArc.parseString("a25,25 -30 0,1 50,-25, 10, 10").asList()
            [0], ["a", [[(25.0, 25.0), -30.0, (False, True), (50.0, -25.0)]]])
...
class TestCurve(unittest.TestCase):
    def testParse(self):
        self.assertEqual(
            curve.parseString(
                "C 100 200 300 400 500 600 100 200 300 400 500 600").asList()[
                    0], [
...
class TestSVG(unittest.TestCase):
    def testParse(self):
        ...
        expected = [["M", [(100, 100)]], ["L", [(300, 100)]],
                    ["L", [(200, 300)]], ("Z", (None, )),
                    ["a", [[(100, 100), -4, (False, True), (25, 25)]]],
                    ("Z", (None, )), ["T", [(300, 1000)]], ["t", [(40, 50)]],
                    ["h", [4, 42, 2, 2, 1]], ["v", [1, 1, 1]], ("Z", (None, )),
                    ["Q", [[(34, 10), (1, 1)]]]]
