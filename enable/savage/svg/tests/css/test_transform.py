...
transformTestsGood = [(skewY, "skewY(10)", ["skewY", [10]]),
...
class TestTransformParser(unittest.TestCase):
    def testTransformList(self):
        self.assertEqual(
            transformList.parseString(
                "matrix(1,2,3,4,5,6) translate(-10), scale(23, 45.9)").asList(
                ), [["matrix", [1, 2, 3, 4, 5, 6]], ["translate", [-10]],
                    ["scale", [23, 45.9]]])
    ...
    def testMatrixTransform(self):
        ...
        expected = [[
            'matrix', [0.966764, 0.0, 0.0, 1.062970, -8.322865, -4.427016]
        ]]
