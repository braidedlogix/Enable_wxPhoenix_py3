...
class Label(Component):
    ...
    traits_view = View(
        Group(
            '<component>', 'enabled', 'selected', id='component'),
        Group(
            '<links>', 'delegate', id='links'),
        Group(
            'text',
            ' ',
            'font',
    ...
    def _draw(self, gc, view_bounds, mode):
        ...
        if bg_color is not transparent_color:
            with gc:
                ...
                gc.begin_path()
                gc.rect(x + ml + bs, y + mb + bs, dx - ml - mr - bsd,
                        dy - mb - mt - bsd)
                gc.fill_path()
        ...
        if bs > 0:
            ...
            if border_color is not transparent_color:
                with gc:
                    ...
                    gc.begin_path()
                    gc.rect(x + ml + bsh, y + mb + bsh, dx - ml - mr - bs,
                            dy - mb - mt - bs)
                    gc.stroke_path()
