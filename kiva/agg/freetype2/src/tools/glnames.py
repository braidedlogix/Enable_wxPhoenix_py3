...
class StringTable:
    ...
    def dump(self, file):
        write = file.write
        write("  static const char  " + self.master_table + "[" + repr(
            self.total) + "] =\n")
        write("  {\n")
    ...
    def dump_sublist(self, file, table_name, macro_name, sublist):
        ...
        write("  /* Values are offsets into the `" + self.master_table +
              "' table */\n\n")
...
def dump_encoding(file, encoding_name, encoding_list):
    ...
    write("  static const unsigned short  " + encoding_name + "[" + repr(
        len(encoding_list)) + "] =\n")
    write("  {\n")
...
def dump_array(the_array, write, array_name):
    ...
    write("  static const unsigned char  " + array_name + "[" + repr(
        len(the_array)) + "L] =\n")
    write("  {\n")
...
def main():
    ...
    st.dump(file)
    st.dump_sublist(file, "ft_mac_names", "FT_NUM_MAC_NAMES",
                    mac_standard_names)
    st.dump_sublist(file, "ft_sid_names", "FT_NUM_SID_NAMES",
                    sid_standard_names)
